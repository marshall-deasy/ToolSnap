...
class FolderSearchDialog(QDialog):
    ...
    def __init__(self, folder_name: str, search_root: Path = Path('C:/'), parent=None):
        """
        Args:
        ...
        # Search for folders and build UI
    ...
    def _search_and_build_ui(self):
        ...
        progress_label = QLabel(f"Searching {self.search_root} for '{self.folder_name}' folders...")
        ...
        self.main_layout.removeWidget(progress_label)
    ...
    def _build_results_ui(self, folders: list[Path]):
        ...
        if not folders:
            ...
            self.main_layout.addWidget(no_results)
