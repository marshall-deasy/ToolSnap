...
def search_folders_by_name(
    ...
    """
    Search for folders with a specific name within common locations.
    
    Args:
        search_root: Root path to search from (e.g., C:/)
        folder_name: Name of folders to find (e.g., 'tools')
        max_depth: Maximum depth to search within each common location
    ...
    # Common locations to search (focused search for speed)
    common_locations = [
        'auto_trading',
        'Users',
        'projects',
    ...
    for location in common_locations:
        location_path = search_root / location
        ...
        try:
            ...
            for depth in range(1, max_depth + 1):
                ...
                try:
                    for item in location_path.glob(pattern):
